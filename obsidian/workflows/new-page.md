...
> [!note] The home view is already built
> `src/views/home.tsx` carries a hero ported from Figma, with its sections in
> `src/views/home/`. It is the worked example of this playbook — read it before
> starting a new page, and extend it rather than scaffolding a route the design
> doesn't call for.
